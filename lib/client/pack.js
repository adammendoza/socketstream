...
var cleanCSS, deleteOldFiles, formatKb, fs, log, magicPath, pathlib, system, view;
...
module.exports = function(ss, client, options) {
  var asset, clientDir, containerDir;
  ...
  // Output CSS  
  client.bundler.packCSS(client, function(files) {
  ...
  // Output JS  
  client.bundler.packJS(client, function(files) {
    var parts = [];
